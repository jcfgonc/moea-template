...
public class MOLauncher {
	...
	public static void main(String[] args) throws ClassNotFoundException, InstantiationException, IllegalAccessException,
			UnsupportedLookAndFeelException, NoSuchFileException, IOException, InterruptedException {
...
//		PatternChromosome.random = new Well44497a();
		...
		properties.setProperty("CustomMutation.Rate", Double.toString(MOConfig.MUTATION_RATE));
